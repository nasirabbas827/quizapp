<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="add_instructor.php">Instructors</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="add_lesson.php">Lessons</a>
      </li>
      <li class="nav-item ">
        <a class="nav-link" href="add_exercise.php">Exercises</a>
      </li>
      <li class="nav-item ">
      ...
      <li class="nav-item ">
        <a class="nav-link" href="admin_reply.php">Student Queries</a>
      </li>
